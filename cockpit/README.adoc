...
| api.customerManagement.enabled | bool | `false` |
| api.customerManagement.entrypoint | string | `"/"` |
| api.customerManagement.ingress.annotations."kubernetes.io/ingress.class" | string | `"nginx"` |
| api.customerManagement.ingress.annotations."nginx.ingress.kubernetes.io/limit-connections" | string | `"10"` |
| api.customerManagement.ingress.annotations."nginx.ingress.kubernetes.io/limit-rps" | string | `"20"` |
| api.customerManagement.ingress.enabled | bool | `true` |
| api.customerManagement.ingress.hosts[0] | string | `"cockpit.example.com"` |
| api.customerManagement.ingress.path | string | `"/customers"` |
| api.customerManagement.ingress.tls[0].hosts[0] | string | `"cockpit.example.com"` |
| api.customerManagement.ingress.tls[0].secretName | string | `"api-custom-cert"` |
| api.customerManagement.port | int | `8065` |
| api.customerManagement.service.enabled | bool | `true` |
| api.customerManagement.service.externalPort | int | `8065` |
