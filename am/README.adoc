...
You can externalize mogodb uri in a k8s secret
[cols=",,",options="header",]
|===
|Parameter |Description |Default
|`+mongo.uriSecret.name+` |k8s secrect containing the uri |`+null+`
|`+mongo.uriSecret.key+` |k8s secrect key containing the uri |`+null+`
|===
