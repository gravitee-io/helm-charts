...
https://github.com/bitnami/charts/tree/f1267104df0dd5900be7629c2ad6dbf90655fbc9[mongodb]
chart).
* logs database (see
...
|===
|Parameter |Description |Default
|`+mongodb.enabled+` |Enable deployment of Mongo replicaset
|`+false+`
|===

See
https://github.com/bitnami/charts/tree/f1267104df0dd5900be7629c2ad6dbf90655fbc9[MongoDB
] for detailed documentation on helm chart.
