...
To prevent potential issues, it is best practice to create a separate namespace for your installation in order to prevent using the default Kubernetes namespace. To do so, run the following command:
